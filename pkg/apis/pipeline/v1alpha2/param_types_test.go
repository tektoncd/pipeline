...
func TestParamSpec_SetDefaults(t *testing.T) {
	tests := []struct {
		name            string
		before          *v1alpha2.ParamSpec
		defaultsApplied *v1alpha2.ParamSpec
	}{{
...
func TestArrayOrString_ApplyReplacements(t *testing.T) {
	...
	tests := []struct {
		name           string
		args           args
		expectedOutput *v1alpha2.ArrayOrString
	}{{
...
type ArrayOrStringHolder struct {
	AOrS v1alpha2.ArrayOrString `json:"val"`
}

func TestArrayOrString_UnmarshalJSON(t *testing.T) {
	cases := []struct {
		input  string
		result v1alpha2.ArrayOrString
	}{
		{"{\"val\": \"123\"}", *builder.ArrayOrString("123")},
		{"{\"val\": \"\"}", *builder.ArrayOrString("")},
		{"{\"val\":[]}", v1alpha2.ArrayOrString{Type: v1alpha2.ParamTypeArray, ArrayVal: []string{}}},
		{"{\"val\":[\"oneelement\"]}", v1alpha2.ArrayOrString{Type: v1alpha2.ParamTypeArray, ArrayVal: []string{"oneelement"}}},
		{"{\"val\":[\"multiple\", \"elements\"]}", v1alpha2.ArrayOrString{Type: v1alpha2.ParamTypeArray, ArrayVal: []string{"multiple", "elements"}}},
	}
