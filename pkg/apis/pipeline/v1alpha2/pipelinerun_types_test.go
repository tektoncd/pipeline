...
func TestInitializeConditions(t *testing.T) {
	...
	p.Status.TaskRuns["fooTask"] = &v1alpha2.PipelineRunTaskRunStatus{}
...
func TestPipelineRunIsCancelled(t *testing.T) {
	pr := &v1alpha2.PipelineRun{
		Spec: v1alpha2.PipelineRunSpec{
			Status: v1alpha2.PipelineRunSpecStatusCancelled,
		},
	}
	if !pr.IsCancelled() {
...
func TestPipelineRunHasStarted(t *testing.T) {
	params := []struct {
		name          string
		prStatus      v1alpha2.PipelineRunStatus
		expectedValue bool
	}{{
		...
		prStatus: v1alpha2.PipelineRunStatus{
			PipelineRunStatusFields: v1alpha2.PipelineRunStatusFields{
	...
	for _, tc := range tcs {
		t.Run(t.Name(), func(t *testing.T) {
			pr := &v1alpha2.PipelineRun{
				...
				Status: v1alpha2.PipelineRunStatus{PipelineRunStatusFields: v1alpha2.PipelineRunStatusFields{
	...
	for _, tt := range []struct {
	...
	}{
		{
			...
			pr: &v1alpha2.PipelineRun{
				...
				Spec: v1alpha2.PipelineRunSpec{
					PipelineRef:        &v1alpha2.PipelineRef{Name: "prs"},
					ServiceAccountName: "defaultSA",
					ServiceAccountNames: []v1alpha2.PipelineRunSpecServiceAccountName{{
