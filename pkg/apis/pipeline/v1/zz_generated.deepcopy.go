...
func (in *InputSpecs) DeepCopyInto(out *InputSpecs) {
	*out = *in
	if in.ParamSpecs != nil {
		in, out := &in.ParamSpecs, &out.ParamSpecs
		*out = make(ParamSpecsMap, len(*in))
		for key, val := range *in {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OutputSpecs) DeepCopyInto(out *OutputSpecs) {
	*out = *in
	if in.ResultSpecs != nil {
		in, out := &in.ResultSpecs, &out.ResultSpecs
		*out = make(map[string]ResultSpec, len(*in))
		for key, val := range *in {
			(*out)[key] = *val.DeepCopy()
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OutputSpecs.
func (in *OutputSpecs) DeepCopy() *OutputSpecs {
	if in == nil {
		return nil
	}
	out := new(OutputSpecs)
...
func (in *Outputs) DeepCopyInto(out *Outputs) {
	*out = *in
	if in.ResultsMap != nil {
		in, out := &in.ResultsMap, &out.ResultsMap
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in ParamSpecsMap) DeepCopyInto(out *ParamSpecsMap) {
	{
		in := &in
		*out = make(ParamSpecsMap, len(*in))
		for key, val := range *in {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ParamSpecsMap.
func (in ParamSpecsMap) DeepCopy() ParamSpecsMap {
	if in == nil {
		return nil
	}
	out := new(ParamSpecsMap)
	in.DeepCopyInto(out)
	return *out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in ParamsMap) DeepCopyInto(out *ParamsMap) {
	{
		in := &in
		*out = make(ParamsMap, len(*in))
		for key, val := range *in {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ParamsMap.
func (in ParamsMap) DeepCopy() ParamsMap {
	if in == nil {
		return nil
	}
	out := new(ParamsMap)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in ResultsMap) DeepCopyInto(out *ResultsMap) {
	{
		in := &in
		*out = make(ResultsMap, len(*in))
		for key, val := range *in {
			(*out)[key] = *val.DeepCopy()
		}
		return
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ResultsMap.
func (in ResultsMap) DeepCopy() ResultsMap {
	if in == nil {
		return nil
	}
	out := new(ResultsMap)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in ResultsSpecsMap) DeepCopyInto(out *ResultsSpecsMap) {
	{
		in := &in
		*out = make(ResultsSpecsMap, len(*in))
		for key, val := range *in {
			(*out)[key] = *val.DeepCopy()
		}
		return
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ResultsSpecsMap.
func (in ResultsSpecsMap) DeepCopy() ResultsSpecsMap {
	if in == nil {
		return nil
	}
	out := new(ResultsSpecsMap)
	in.DeepCopyInto(out)
	return *out
}
