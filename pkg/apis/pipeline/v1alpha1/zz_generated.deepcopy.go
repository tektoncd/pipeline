...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TaskBuildStep) DeepCopyInto(out *TaskBuildStep) {
	*out = *in
	if in.Paths != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TaskBuildStep.
func (in *TaskBuildStep) DeepCopy() *TaskBuildStep {
	if in == nil {
		return nil
	}
	out := new(TaskBuildStep)
	in.DeepCopyInto(out)
	return out
}
...
func (in *TaskRunResourceVersion) DeepCopyInto(out *TaskRunResourceVersion) {
	*out = *in
	out.ResourceRef = in.ResourceRef
	if in.SourcePaths != nil {
		in, out := &in.SourcePaths, &out.SourcePaths
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	return
...
func (in *TaskRunSpec) DeepCopyInto(out *TaskRunSpec) {
	*out = *in
	...
	in.Results.DeepCopyInto(&out.Results)
	if in.PreBuiltSteps != nil {
		in, out := &in.PreBuiltSteps, &out.PreBuiltSteps
		*out = make([]TaskBuildStep, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.PostBuiltSteps != nil {
		in, out := &in.PostBuiltSteps, &out.PostBuiltSteps
		*out = make([]TaskBuildStep, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
