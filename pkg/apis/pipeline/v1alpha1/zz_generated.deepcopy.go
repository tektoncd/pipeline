...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ArrayOrStringParam) DeepCopyInto(out *ArrayOrStringParam) {
	*out = *in
	in.Value.DeepCopyInto(&out.Value)
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ArrayOrStringParam.
func (in *ArrayOrStringParam) DeepCopy() *ArrayOrStringParam {
	if in == nil {
		return nil
	}
	out := new(ArrayOrStringParam)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PipelineRunSpec) DeepCopyInto(out *PipelineRunSpec) {
	*out = *in
	...
	if in.Params != nil {
		in, out := &in.Params, &out.Params
		*out = make([]ArrayOrStringParam, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
