...
func (in *PipelineRunTaskRunStatus) DeepCopyInto(out *PipelineRunTaskRunStatus) {
	*out = *in
	...
	if in.ConditionChecks != nil {
		...
		*out = make(map[string]*v1alpha2.PipelineRunConditionCheckStatus, len(*in))
		for key, val := range *in {
			var outVal *v1alpha2.PipelineRunConditionCheckStatus
			if val == nil {
				(*out)[key] = nil
			} else {
				in, out := &val, &outVal
				*out = new(v1alpha2.PipelineRunConditionCheckStatus)
				(*in).DeepCopyInto(*out)
			}
			(*out)[key] = outVal
		}
...
func (in *PipelineSpec) DeepCopyInto(out *PipelineSpec) {
	*out = *in
	...
	if in.Workspaces != nil {
		in, out := &in.Workspaces, &out.Workspaces
		*out = make([]v1alpha2.PipelineWorkspaceDeclaration, len(*in))
		copy(*out, *in)
	}
	return
}
...
func (in *PipelineTask) DeepCopyInto(out *PipelineTask) {
	*out = *in
	...
	if in.Workspaces != nil {
		in, out := &in.Workspaces, &out.Workspaces
		*out = make([]v1alpha2.PipelineTaskWorkspaceBinding, len(*in))
		copy(*out, *in)
	}
	return
}
