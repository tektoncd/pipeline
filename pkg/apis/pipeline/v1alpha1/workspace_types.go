...
type PipelineWorkspaceDeclaration = v1alpha2.PipelineWorkspaceDeclaration
...
type PipelineTaskWorkspaceBinding = v1alpha2.PipelineTaskWorkspaceBinding

// WorkspaceFromClause describes a previous task and its workspace name from which to reuse
// volume configuration.
type WorkspaceFromClause = v1alpha2.WorkspaceFromClause
