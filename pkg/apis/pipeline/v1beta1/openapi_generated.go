		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"debug": {
						SchemaProps: spec.SchemaProps{
							Description: "Debug allows debug settings to be added to any Task created by this PipelineRun",
