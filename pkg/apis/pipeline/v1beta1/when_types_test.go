...
func TestGetWhenExpressionsStatus(t *testing.T) {
	tests := []struct {
		name            string
		whenExpressions WhenExpressions
		expected        WhenExpressionsEvaluationStatus
	}{{
		name: "in expression",
		whenExpressions: WhenExpressions{
			{
		...
		expected: WhenExpressionsEvaluationStatus{
			EvaluationResults: []*WhenExpressionEvaluationResult{
				{
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			got := tc.whenExpressions.GetWhenExpressionsStatus()
