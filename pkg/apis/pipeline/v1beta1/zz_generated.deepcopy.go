...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TaskRunBreakpoint) DeepCopyInto(out *TaskRunBreakpoint) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TaskRunBreakpoint.
func (in *TaskRunBreakpoint) DeepCopy() *TaskRunBreakpoint {
	if in == nil {
		return nil
	}
	out := new(TaskRunBreakpoint)
	in.DeepCopyInto(out)
	return out
}
