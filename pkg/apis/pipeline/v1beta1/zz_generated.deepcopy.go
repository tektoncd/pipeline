...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PipelineRunCustomRunStatus) DeepCopyInto(out *PipelineRunCustomRunStatus) {
	*out = *in
	if in.CustomRunStatus != nil {
		in, out := &in.CustomRunStatus, &out.CustomRunStatus
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PipelineRunCustomRunStatus.
func (in *PipelineRunCustomRunStatus) DeepCopy() *PipelineRunCustomRunStatus {
	if in == nil {
		return nil
	}
	out := new(PipelineRunCustomRunStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PipelineRunStatusFields) DeepCopyInto(out *PipelineRunStatusFields) {
	*out = *in
	...
	if in.CustomRuns != nil {
		in, out := &in.CustomRuns, &out.CustomRuns
		*out = make(map[string]*PipelineRunCustomRunStatus, len(*in))
		for key, val := range *in {
			var outVal *PipelineRunCustomRunStatus
			if val == nil {
				(*out)[key] = nil
			} else {
				in, out := &val, &outVal
