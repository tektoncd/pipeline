...
func (in *PipelineTask) DeepCopyInto(out *PipelineTask) {
	*out = *in
	...
	if in.RunOn != nil {
		...
		*out = make([]PipelineTaskRunOn, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PipelineTaskRunOn) DeepCopyInto(out *PipelineTaskRunOn) {
	*out = *in
	if in.States != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PipelineTaskRunOn.
func (in *PipelineTaskRunOn) DeepCopy() *PipelineTaskRunOn {
	if in == nil {
		return nil
	}
	out := new(PipelineTaskRunOn)
	in.DeepCopyInto(out)
	return out
}
