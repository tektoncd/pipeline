...
func (in *PipelineRunTaskRunStatus) DeepCopyInto(out *PipelineRunTaskRunStatus) {
	*out = *in
	...
	if in.WhenExpressionsResults != nil {
		in, out := &in.WhenExpressionsResults, &out.WhenExpressionsResults
		*out = new(WhenExpressionsEvaluationStatus)
		(*in).DeepCopyInto(*out)
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WhenExpressionEvaluationResult) DeepCopyInto(out *WhenExpressionEvaluationResult) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WhenExpressionEvaluationResult.
func (in *WhenExpressionEvaluationResult) DeepCopy() *WhenExpressionEvaluationResult {
	if in == nil {
		return nil
	}
	out := new(WhenExpressionEvaluationResult)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WhenExpressionsEvaluationStatus) DeepCopyInto(out *WhenExpressionsEvaluationStatus) {
	*out = *in
	if in.EvaluationResults != nil {
		in, out := &in.EvaluationResults, &out.EvaluationResults
		*out = make([]*WhenExpressionEvaluationResult, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(WhenExpressionEvaluationResult)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WhenExpressionsEvaluationResults.
func (in *WhenExpressionsEvaluationStatus) DeepCopy() *WhenExpressionsEvaluationStatus {
	if in == nil {
		return nil
	}
	out := new(WhenExpressionsEvaluationStatus)
