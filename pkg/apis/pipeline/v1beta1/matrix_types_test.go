				...
				Include: v1beta1.IncludeParamsList{
					{
						...
						Params: v1beta1.Params{{
							Name: "GOARCH", Value: v1beta1.ParamValue{Type: v1beta1.ParamTypeString, StringVal: "linux/s390x"}}, {
							Name: "flags", Value: v1beta1.ParamValue{Type: v1beta1.ParamTypeString, StringVal: "-cover -v"}}, {
							Name: "version", Value: v1beta1.ParamValue{Type: v1beta1.ParamTypeString, StringVal: "go1.18.1"}}},
					},
					{
						Name: "amd64-no-race",
						Params: v1beta1.Params{{
...
func TestMatrix_HasParams(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			matrix: &v1beta1.Matrix{
				Params: v1beta1.Params{{Name: "platform", Value: v1beta1.ParamValue{ArrayVal: []string{"linux", "windows"}}}},
			},
			want: true,
		}, {
...
func TestMatrix_GetAllParams(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			want: v1beta1.Params{{Name: "platform", Value: v1beta1.ParamValue{ArrayVal: []string{"linux", "windows"}}}},
		}, {
			name: "matrixed with include",
			matrix: &v1beta1.Matrix{
				Include: v1beta1.IncludeParamsList{{
...
func TestPipelineTask_CountCombinations(t *testing.T) {
	tests := []struct {
		...
		matrix: &v1beta1.Matrix{
			Params: v1beta1.Params{{
				Name: "foo", Value: v1beta1.ParamValue{Type: v1beta1.ParamTypeArray, ArrayVal: []string{"foo"}},
			}}},
		...
		matrix: &v1beta1.Matrix{
			Params: v1beta1.Params{{
				...
				Name: "bar", Value: v1beta1.ParamValue{Type: v1beta1.ParamTypeArray, ArrayVal: []string{"bar"}},
			}}},
		want: 1,
	}, {
		...
		matrix: &v1beta1.Matrix{
			Params: v1beta1.Params{{
				Name: "foo", Value: v1beta1.ParamValue{Type: v1beta1.ParamTypeArray, ArrayVal: []string{"foo", "bar"}},
			}}},
		want: 2,
	}, {
		...
		matrix: &v1beta1.Matrix{
			Params: v1beta1.Params{{
				Name: "foo", Value: v1beta1.ParamValue{Type: v1beta1.ParamTypeArray, ArrayVal: []string{"f", "o", "o"}},
			}, {
				Name: "bar", Value: v1beta1.ParamValue{Type: v1beta1.ParamTypeArray, ArrayVal: []string{"b", "a", "r"}},
			}}},
		want: 9,
	}, {
		...
		matrix: &v1beta1.Matrix{
			Params: v1beta1.Params{{
				...
				Name: "quz", Value: v1beta1.ParamValue{Type: v1beta1.ParamTypeArray, ArrayVal: []string{"q", "u", "x"}},
			}, {
				Name: "xyzzy", Value: v1beta1.ParamValue{Type: v1beta1.ParamTypeArray, ArrayVal: []string{"x", "y", "z", "z", "y"}},
			}}},
		want: 135,
	}, {
...
func TestPipelineTask_CountMaxCombinations(t *testing.T) {
	...
	matrix := &v1beta1.Matrix{
		Params: v1beta1.Params{{
			Name: "GOARCH", Value: v1beta1.ParamValue{Type: v1beta1.ParamTypeArray, ArrayVal: []string{"linux/amd64", "linux/ppc64le"}},
		}},
		Include: v1beta1.IncludeParamsList{{
			...
			Params: v1beta1.Params{{
				Name: "GOARCH", Value: v1beta1.ParamValue{Type: v1beta1.ParamTypeString, StringVal: "linux/arm64"}}},
			When: v1beta1.WhenExpressions{{
