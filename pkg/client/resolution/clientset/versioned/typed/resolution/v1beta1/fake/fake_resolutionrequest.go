...
func (c *FakeResolutionRequests) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.ResolutionRequest, err error) {
	emptyResult := &v1beta1.ResolutionRequest{}
	obj, err := c.Fake.
...
func (c *FakeResolutionRequests) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.ResolutionRequestList, err error) {
	emptyResult := &v1beta1.ResolutionRequestList{}
	obj, err := c.Fake.
...
func (c *FakeResolutionRequests) UpdateStatus(ctx context.Context, resolutionRequest *v1beta1.ResolutionRequest, opts v1.UpdateOptions) (result *v1beta1.ResolutionRequest, err error) {
	emptyResult := &v1beta1.ResolutionRequest{}
	obj, err := c.Fake.
