...
type resolutionRequests struct {
	*gentype.ClientWithList[*v1alpha1.ResolutionRequest, *v1alpha1.ResolutionRequestList]
}
...
func newResolutionRequests(c *ResolutionV1alpha1Client, namespace string) *resolutionRequests {
	return &resolutionRequests{
		gentype.NewClientWithList[*v1alpha1.ResolutionRequest, *v1alpha1.ResolutionRequestList](
			"resolutionrequests",
			c.RESTClient(),
