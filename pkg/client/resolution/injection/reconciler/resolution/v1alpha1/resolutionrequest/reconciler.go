...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.ResolutionRequest, desiredFinalizers sets.String) (*v1alpha1.ResolutionRequest, error) {
	// Don't modify the informers copy.
