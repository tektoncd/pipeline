...
import (
	...
	fake "github.com/tektoncd/pipeline/pkg/client/queue/clientset/versioned/fake"
...
func Get(ctx context.Context) *fake.Clientset {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch github.com/tektoncd/pipeline/pkg/client/queue/clientset/versioned/fake.Clientset from context.")
	}
