...
import (
	...
	factory "github.com/tektoncd/pipeline/pkg/client/queue/injection/informers/factory"
...
func Get(ctx context.Context) v1alpha1.QueueInformer {
	untyped := ctx.Value(Key{})
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch github.com/tektoncd/pipeline/pkg/client/queue/informers/externalversions/queue/v1alpha1.QueueInformer from context.")
	}
