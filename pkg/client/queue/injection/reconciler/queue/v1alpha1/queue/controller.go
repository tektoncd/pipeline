...
import (
	...
	versionedscheme "github.com/tektoncd/pipeline/pkg/client/queue/clientset/versioned/scheme"
	client "github.com/tektoncd/pipeline/pkg/client/queue/injection/client"
	queue "github.com/tektoncd/pipeline/pkg/client/queue/injection/informers/queue/v1alpha1/queue"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "queue-controller"
	defaultFinalizerName       = "queues.tekton.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	queueInformer := queue.Get(ctx)

	lister := queueInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "tekton.dev.Queue"),
	)
