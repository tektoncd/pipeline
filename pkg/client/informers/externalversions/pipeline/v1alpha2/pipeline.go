...
type PipelineInformer interface {
	...
	Lister() v1alpha2.PipelineLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.TektonV1alpha2().Pipelines(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TektonV1alpha2().Pipelines(namespace).Watch(options)
			},
		},
		&pipelinev1alpha2.Pipeline{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *pipelineInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&pipelinev1alpha2.Pipeline{}, f.defaultInformer)
}

func (f *pipelineInformer) Lister() v1alpha2.PipelineLister {
	return v1alpha2.NewPipelineLister(f.Informer().GetIndexer())
}
