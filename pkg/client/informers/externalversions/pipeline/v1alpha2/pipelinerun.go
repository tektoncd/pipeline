...
type PipelineRunInformer interface {
	...
	Lister() v1alpha2.PipelineRunLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.TektonV1alpha2().PipelineRuns(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TektonV1alpha2().PipelineRuns(namespace).Watch(options)
			},
		},
		&pipelinev1alpha2.PipelineRun{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *pipelineRunInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&pipelinev1alpha2.PipelineRun{}, f.defaultInformer)
}

func (f *pipelineRunInformer) Lister() v1alpha2.PipelineRunLister {
	return v1alpha2.NewPipelineRunLister(f.Informer().GetIndexer())
}
