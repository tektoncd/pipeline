...
type PipelineResourceInterface interface {
	Create(*v1alpha2.PipelineResource) (*v1alpha2.PipelineResource, error)
	Update(*v1alpha2.PipelineResource) (*v1alpha2.PipelineResource, error)
	UpdateStatus(*v1alpha2.PipelineResource) (*v1alpha2.PipelineResource, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha2.PipelineResource, error)
	List(opts v1.ListOptions) (*v1alpha2.PipelineResourceList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha2.PipelineResource, err error)
...
func newPipelineResources(c *TektonV1alpha2Client, namespace string) *pipelineResources {
...
func (c *pipelineResources) Get(name string, options v1.GetOptions) (result *v1alpha2.PipelineResource, err error) {
	result = &v1alpha2.PipelineResource{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *pipelineResources) List(opts v1.ListOptions) (result *v1alpha2.PipelineResourceList, err error) {
	result = &v1alpha2.PipelineResourceList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("pipelineresources").
...
func (c *pipelineResources) Create(pipelineResource *v1alpha2.PipelineResource) (result *v1alpha2.PipelineResource, err error) {
	result = &v1alpha2.PipelineResource{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("pipelineresources").
...
func (c *pipelineResources) Update(pipelineResource *v1alpha2.PipelineResource) (result *v1alpha2.PipelineResource, err error) {
	result = &v1alpha2.PipelineResource{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("pipelineresources").
...
func (c *pipelineResources) UpdateStatus(pipelineResource *v1alpha2.PipelineResource) (result *v1alpha2.PipelineResource, err error) {
	result = &v1alpha2.PipelineResource{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("pipelineresources").
...
func (c *pipelineResources) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha2.PipelineResource, err error) {
	result = &v1alpha2.PipelineResource{}
