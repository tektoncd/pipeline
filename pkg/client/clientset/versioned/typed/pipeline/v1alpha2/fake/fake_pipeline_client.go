...
func (c *FakeTektonV1alpha2) Conditions(namespace string) v1alpha2.ConditionInterface {
...
func (c *FakeTektonV1alpha2) PipelineResources(namespace string) v1alpha2.PipelineResourceInterface {
