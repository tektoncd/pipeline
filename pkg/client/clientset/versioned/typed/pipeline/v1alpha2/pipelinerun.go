...
type PipelineRunInterface interface {
	Create(*v1alpha2.PipelineRun) (*v1alpha2.PipelineRun, error)
	Update(*v1alpha2.PipelineRun) (*v1alpha2.PipelineRun, error)
	UpdateStatus(*v1alpha2.PipelineRun) (*v1alpha2.PipelineRun, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha2.PipelineRun, error)
	List(opts v1.ListOptions) (*v1alpha2.PipelineRunList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha2.PipelineRun, err error)
...
func newPipelineRuns(c *TektonV1alpha2Client, namespace string) *pipelineRuns {
	return &pipelineRuns{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *pipelineRuns) Get(name string, options v1.GetOptions) (result *v1alpha2.PipelineRun, err error) {
	result = &v1alpha2.PipelineRun{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *pipelineRuns) List(opts v1.ListOptions) (result *v1alpha2.PipelineRunList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha2.PipelineRunList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("pipelineruns").
...
func (c *pipelineRuns) Create(pipelineRun *v1alpha2.PipelineRun) (result *v1alpha2.PipelineRun, err error) {
	result = &v1alpha2.PipelineRun{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("pipelineruns").
...
func (c *pipelineRuns) Update(pipelineRun *v1alpha2.PipelineRun) (result *v1alpha2.PipelineRun, err error) {
	result = &v1alpha2.PipelineRun{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("pipelineruns").
...
func (c *pipelineRuns) UpdateStatus(pipelineRun *v1alpha2.PipelineRun) (result *v1alpha2.PipelineRun, err error) {
	result = &v1alpha2.PipelineRun{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("pipelineruns").
...
func (c *pipelineRuns) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha2.PipelineRun, err error) {
	result = &v1alpha2.PipelineRun{}
