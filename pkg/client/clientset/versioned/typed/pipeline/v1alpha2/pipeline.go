...
type PipelineInterface interface {
	Create(*v1alpha2.Pipeline) (*v1alpha2.Pipeline, error)
	Update(*v1alpha2.Pipeline) (*v1alpha2.Pipeline, error)
	UpdateStatus(*v1alpha2.Pipeline) (*v1alpha2.Pipeline, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha2.Pipeline, error)
	List(opts v1.ListOptions) (*v1alpha2.PipelineList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha2.Pipeline, err error)
	PipelineExpansion
}
...
func newPipelines(c *TektonV1alpha2Client, namespace string) *pipelines {
	return &pipelines{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *pipelines) Get(name string, options v1.GetOptions) (result *v1alpha2.Pipeline, err error) {
	result = &v1alpha2.Pipeline{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("pipelines").
		Name(name).
...
func (c *pipelines) List(opts v1.ListOptions) (result *v1alpha2.PipelineList, err error) {
	result = &v1alpha2.PipelineList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("pipelines").
...
func (c *pipelines) Create(pipeline *v1alpha2.Pipeline) (result *v1alpha2.Pipeline, err error) {
	result = &v1alpha2.Pipeline{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("pipelines").
...
func (c *pipelines) Update(pipeline *v1alpha2.Pipeline) (result *v1alpha2.Pipeline, err error) {
	result = &v1alpha2.Pipeline{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("pipelines").
...
func (c *pipelines) UpdateStatus(pipeline *v1alpha2.Pipeline) (result *v1alpha2.Pipeline, err error) {
	result = &v1alpha2.Pipeline{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("pipelines").
...
func (c *pipelines) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha2.Pipeline, err error) {
	result = &v1alpha2.Pipeline{}
