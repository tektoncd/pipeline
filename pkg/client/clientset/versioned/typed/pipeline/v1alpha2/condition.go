...
type ConditionInterface interface {
	Create(*v1alpha2.Condition) (*v1alpha2.Condition, error)
	Update(*v1alpha2.Condition) (*v1alpha2.Condition, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha2.Condition, error)
	List(opts v1.ListOptions) (*v1alpha2.ConditionList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha2.Condition, err error)
	ConditionExpansion
}
...
func newConditions(c *TektonV1alpha2Client, namespace string) *conditions {
	return &conditions{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *conditions) Get(name string, options v1.GetOptions) (result *v1alpha2.Condition, err error) {
...
func (c *conditions) List(opts v1.ListOptions) (result *v1alpha2.ConditionList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha2.ConditionList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("conditions").
...
func (c *conditions) Create(condition *v1alpha2.Condition) (result *v1alpha2.Condition, err error) {
	result = &v1alpha2.Condition{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("conditions").
...
func (c *conditions) Update(condition *v1alpha2.Condition) (result *v1alpha2.Condition, err error) {
	result = &v1alpha2.Condition{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("conditions").
...
func (c *conditions) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha2.Condition, err error) {
	result = &v1alpha2.Condition{}
