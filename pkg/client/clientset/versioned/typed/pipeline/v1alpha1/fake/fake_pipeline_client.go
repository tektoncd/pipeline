...
import (
	v1alpha1 "github.com/knative/build-pipeline/pkg/client/clientset/versioned/typed/pipeline/v1alpha1"
...
func (c *FakePipelineV1alpha1) TaskRuns(namespace string) v1alpha1.TaskRunInterface {
