...
import (
	...
	concurrencycontrol "github.com/tektoncd/pipeline/pkg/client/injection/informers/pipeline/v1alpha1/concurrencycontrol"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "concurrencycontrol-controller"
	defaultFinalizerName       = "concurrencycontrols.tekton.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	concurrencycontrolInformer := concurrencycontrol.Get(ctx)

	lister := concurrencycontrolInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "tekton.dev.ConcurrencyControl"),
	)
