...
func (r *reconcilerImpl) updateFinalizersFilteredServerSideApply(ctx context.Context, resource *v1alpha1.VerificationPolicy, desiredFinalizers sets.Set[string]) (*v1alpha1.VerificationPolicy, error) {
...
func (r *reconcilerImpl) updateFinalizersFilteredMergePatch(ctx context.Context, resource *v1alpha1.VerificationPolicy, desiredFinalizers sets.Set[string]) (*v1alpha1.VerificationPolicy, error) {
	// Don't modify the informers copy.
...
func (r *reconcilerImpl) clearFinalizer(ctx context.Context, resource *v1alpha1.VerificationPolicy, reconcileEvent reconciler.Event) (*v1alpha1.VerificationPolicy, error) {
	...
	if err != nil {
		...
		getter := r.Client.TektonV1alpha1().VerificationPolicies(resource.Namespace)
