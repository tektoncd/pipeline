...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.VerificationPolicy, desiredFinalizers sets.String) (*v1alpha1.VerificationPolicy, error) {
	// Don't modify the informers copy.
