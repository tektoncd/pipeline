...
func (r *reconcilerImpl) updateFinalizersFilteredServerSideApply(ctx context.Context, resource *v1alpha1.Run, desiredFinalizers sets.Set[string]) (*v1alpha1.Run, error) {
...
func (r *reconcilerImpl) updateFinalizersFilteredMergePatch(ctx context.Context, resource *v1alpha1.Run, desiredFinalizers sets.Set[string]) (*v1alpha1.Run, error) {
	// Don't modify the informers copy.
...
func (r *reconcilerImpl) clearFinalizer(ctx context.Context, resource *v1alpha1.Run, reconcileEvent reconciler.Event) (*v1alpha1.Run, error) {
	...
	if err != nil {
		...
		getter := r.Client.TektonV1alpha1().Runs(resource.Namespace)
