...
type PipelineResourceLister interface {
	...
	List(selector labels.Selector) (ret []*v1alpha2.PipelineResource, err error)
...
// List lists all PipelineResources in the indexer.
func (s *pipelineResourceLister) List(selector labels.Selector) (ret []*v1alpha2.PipelineResource, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1alpha2.PipelineResource))
	})
	return ret, err
}
...
type PipelineResourceNamespaceLister interface {
	...
	Get(name string) (*v1alpha2.PipelineResource, error)
...
// List lists all PipelineResources in the indexer for a given namespace.
func (s pipelineResourceNamespaceLister) List(selector labels.Selector) (ret []*v1alpha2.PipelineResource, err error) {
...
// Get retrieves the PipelineResource from the indexer for a given namespace and name.
func (s pipelineResourceNamespaceLister) Get(name string) (*v1alpha2.PipelineResource, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1alpha2.Resource("pipelineresource"), name)
	}
	return obj.(*v1alpha2.PipelineResource), nil
}
