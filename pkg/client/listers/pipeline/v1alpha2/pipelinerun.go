...
type PipelineRunLister interface {
	...
	List(selector labels.Selector) (ret []*v1alpha2.PipelineRun, err error)
...
// List lists all PipelineRuns in the indexer.
func (s *pipelineRunLister) List(selector labels.Selector) (ret []*v1alpha2.PipelineRun, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1alpha2.PipelineRun))
	})
	return ret, err
}
...
type PipelineRunNamespaceLister interface {
	...
	Get(name string) (*v1alpha2.PipelineRun, error)
...
// List lists all PipelineRuns in the indexer for a given namespace.
func (s pipelineRunNamespaceLister) List(selector labels.Selector) (ret []*v1alpha2.PipelineRun, err error) {
...
// Get retrieves the PipelineRun from the indexer for a given namespace and name.
func (s pipelineRunNamespaceLister) Get(name string) (*v1alpha2.PipelineRun, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1alpha2.Resource("pipelinerun"), name)
	}
	return obj.(*v1alpha2.PipelineRun), nil
}
