...
func (e Entrypointer) Go() error {
	...
	if err == nil {
		...
		if err := e.applyStepArtifactSubstitutions(pipeline.StepsDir, "/tekton/scripts"); err != nil {
...
func parseArtifactTemplate(template string) (ArtifactTemplate, error) {
	if template == "" {
		return ArtifactTemplate{}, fmt.Errorf("template is empty")
	}
...
//	scriptDir: The directory where scripts are stored.
//
// Returns:
//
//	An error object if any issues occur during substitution.
func (e *Entrypointer) applyStepArtifactSubstitutions(stepDir string, scriptDir string) error {
