...
func TestEntryPointOnError(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		err: errors.New("task step onError must be \"continue\", \"stopAndFail\" or \"continueAndFail\" but it is set to an invalid value \"invalid-on-error\""),
	}} {
