...
func taskRunPodRescheduleCount(taskRun *v1.TaskRun) int {
	condition := taskRun.Status.GetCondition(apis.ConditionSucceeded)
	if condition == nil || condition.Reason != v1.TaskRunReasonPodRescheduled.String() {
		return 0
	}
...
func (b *Builder) Build(ctx context.Context, taskRun *v1.TaskRun, taskSpec v1.TaskSpec, transformers ...Transformer) (*corev1.Pod, error) {
	...
	podNameSuffix := taskRunPodNameSuffix(taskRun)
	newPod := &corev1.Pod{
