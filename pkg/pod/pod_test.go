	...
	for _, c := range []struct {
		...
		want: &corev1.PodSpec{
			...
			Containers: []corev1.Container{{
				...
				Env:                    implicitEnvVars,
				VolumeMounts:           append([]corev1.VolumeMount{toolsMount, logCfgMount, downwardMount}, implicitVolumeMounts...),
				WorkingDir:             pipeline.WorkspaceDir,
				Resources:              corev1.ResourceRequirements{Requests: allZeroQty()},
				TerminationMessagePath: "/tekton/termination",
			}},
			Volumes: append(implicitVolumes, toolsVolume, downwardVolume, logCfgVolume),
		},
	}, {
		...
		want: &corev1.PodSpec{
			...
			Volumes: append(implicitVolumes, secretsVolume, toolsVolume, downwardVolume, logCfgVolume),
		},
	}, {
...
`},
			...
			Volumes: append(implicitVolumes, scriptsVolume, toolsVolume, downwardVolume, logCfgVolume),
		},
	}, {
		...
		want: &corev1.PodSpec{
			...
			Containers: []corev1.Container{{
				...
				Env:          implicitEnvVars,
				VolumeMounts: append([]corev1.VolumeMount{toolsMount, logCfgMount}, implicitVolumeMounts...),
				WorkingDir:   pipeline.WorkspaceDir,
				Resources: corev1.ResourceRequirements{
					Requests: corev1.ResourceList{
...
`},
			...
			Containers: []corev1.Container{{
				...
				VolumeMounts:           append([]corev1.VolumeMount{scriptsVolumeMount, toolsMount, logCfgMount, downwardMount}, implicitVolumeMounts...),
				WorkingDir:             pipeline.WorkspaceDir,
				Resources:              corev1.ResourceRequirements{Requests: allZeroQty()},
				TerminationMessagePath: "/tekton/termination",
			}, {
				...
				Env:                    append(implicitEnvVars, corev1.EnvVar{Name: "FOO", Value: "bar"}),
				VolumeMounts:           append([]corev1.VolumeMount{{Name: "i-have-a-volume-mount"}, scriptsVolumeMount, toolsMount, logCfgMount}, implicitVolumeMounts...),
				WorkingDir:             pipeline.WorkspaceDir,
				Resources:              corev1.ResourceRequirements{Requests: allZeroQty()},
				TerminationMessagePath: "/tekton/termination",
			}, {
