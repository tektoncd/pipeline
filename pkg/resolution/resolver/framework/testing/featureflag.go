...
// ContextWithBundleResolverEnabled returns a context containing a Config with the enable-bundle-resolver feature flag enabled.
func ContextWithBundleResolverEnabled(ctx context.Context) context.Context {
	return contextWithResolverEnabled(ctx, "enable-tekton-oci-bundles")
}
