...
func (r *FakeResolver) ValidateParams(_ context.Context, params map[string]v1beta1.ArrayOrString) error {
	required := []string{
		FakeParamName,
	}
	missing := []string{}
...
// parameters.
func (r *FakeResolver) Resolve(_ context.Context, params map[string]v1beta1.ArrayOrString) (ResolvedResource, error) {
	paramValue := params[FakeParamName].StringVal
