...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &pipelinev1beta1.Task{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &appsv1.Deployment{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &pipelinev1beta1.Task{},
	})
	if err != nil {
		return err
	}
...
// +kubebuilder:rbac:groups=pipeline.knative.dev,resources=tasks,verbs=get;list;watch;create;update;patch;delete
