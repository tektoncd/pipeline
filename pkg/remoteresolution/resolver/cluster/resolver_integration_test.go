...
func TestValidateWithNoParams(t *testing.T) {
	...
	// Test Validate with no parameters
	...
	if err.Error() != "cannot validate request. the Validate method has not been implemented" {
...
func TestAnnotatedResourceCreation(t *testing.T) {
	...
	annotatedResource := cache.NewAnnotatedResource(mockResource, "cluster")
