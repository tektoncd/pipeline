...
func TestValidateNoReferencesToUnknownVariables(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		args: args{
			...
			prefix: "params",
			vars:   sets.New[string]("foo.bar.baz"),
		},
		expectedError: nil,
	}, {
		...
		args: args{
			...
			vars:   sets.New[string]("key1", "key2"),
		},
		expectedError: nil,
	}, {
...
func TestValidateNoReferencesToProhibitedVariables(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		args: args{
			...
			prefix: "params",
			vars:   sets.New[string]("arrayParam"),
		},
		wantErr: false,
	}, {
		...
		args: args{
			input:  "--flag=$(params.objectParam.key1)",
			prefix: "params",
			vars:   sets.New[string]("objectParam"),
		},
		wantErr: true,
	}} {
		t.Run(tc.name, func(t *testing.T) {
