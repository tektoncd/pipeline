...
// VerificationResult is the result from trusted resources if the feature is enabled.
type GetTask func(context.Context, string) (*internalversion.Task, *v1.RefSource, *trustedresources.VerificationResult, error)
...
func GetTaskData(ctx context.Context, taskRun *v1.TaskRun, getTask GetTask) (*resolutionutil.ResolvedObjectMeta, *internalversion.TaskSpec, error) {
