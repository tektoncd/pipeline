...
//
// Deprecated: status.cloudEvents is no longer populated as of TEP-0137.
// This function will be removed once the CloudEventDelivery field is removed from the API.
