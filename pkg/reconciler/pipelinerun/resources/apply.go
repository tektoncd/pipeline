		...
		if resolvedPipelineRunTask.PipelineTask != nil {
			...
			if pipelineTask.IsMatrixed() {
				...
				for i := range pipelineTask.Matrix.Include {
					...
					if pipelineTask.Matrix.Include[i].When != nil {
						pipelineTask.Matrix.Include[i].When = pipelineTask.Matrix.Include[i].When.ReplaceVariables(stringReplacements, arrayReplacements)
					}
				}
			}
