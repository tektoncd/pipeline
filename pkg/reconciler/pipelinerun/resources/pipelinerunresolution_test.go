...
func nopGetTask(context.Context, string) (*v1.Task, *v1.RefSource, error) {
...
func TestResolvePipelineRun_PipelineTaskHasNoResources(t *testing.T) {
	...
	getTask := func(ctx context.Context, name string) (*v1.Task, *v1.RefSource, error) {
		return task, nil, nil
	}
...
func TestResolvePipeline_WhenExpressions(t *testing.T) {
	...
	getTask := func(_ context.Context, name string) (*v1.Task, *v1.RefSource, error) {
		return task, nil, nil
	}
	pr := v1.PipelineRun{
		ObjectMeta: metav1.ObjectMeta{
