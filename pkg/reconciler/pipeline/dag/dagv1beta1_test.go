...
// These tests duplicated the tests in dag_test.go but use v1beta1 instead
// of v1alpha1 because differences in the Deps function (which is only tested
// in this file) led to #2463. Once #2410 is complete we can assume we are only
...
func TestGetSchedulable_v1beta1(t *testing.T) {
	g := testGraphv1beta1(t)
	tcs := []struct {
		name          string
		finished      []string
...
func TestGetSchedulable_Invalid_v1beta1(t *testing.T) {
	g := testGraphv1beta1(t)
	tcs := []struct {
		name     string
		finished []string
...
func TestBuild_Parallel_v1beta1(t *testing.T) {
...
func TestBuild_JoinMultipleRoots_v1beta1(t *testing.T) {
	a := v1beta1.PipelineTask{Name: "a"}
	b := v1beta1.PipelineTask{Name: "b"}
	c := v1beta1.PipelineTask{Name: "c"}
...
func TestBuild_FanInFanOut_v1beta1(t *testing.T) {
	a := v1beta1.PipelineTask{Name: "a"}
...
func TestBuild_Invalid_v1beta1(t *testing.T) {
	a := v1beta1.PipelineTask{Name: "a"}
	xDependsOnA := v1beta1.PipelineTask{
		Name: "x",
		Resources: &v1beta1.PipelineTaskResources{
...
func TestBuild_ConditionResources_v1beta1(t *testing.T) {
...
func TestBuild_TaskParamsFromTaskResults_v1beta1(t *testing.T) {
	a := v1beta1.PipelineTask{Name: "a"}
	b := v1beta1.PipelineTask{Name: "b"}
	c := v1beta1.PipelineTask{Name: "c"}
...
func TestBuild_ConditionsParamsFromTaskResults_v1beta1(t *testing.T) {
	a := v1beta1.PipelineTask{Name: "a"}
	xDependsOnA := v1beta1.PipelineTask{
		Name: "x",
		Conditions: []v1beta1.PipelineTaskCondition{{
