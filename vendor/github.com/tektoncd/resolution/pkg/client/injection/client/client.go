...
import (
	...
	typedresolutionv1alpha1 "github.com/tektoncd/resolution/pkg/client/clientset/versioned/typed/resolution/v1alpha1"
	...
	if untyped == nil {
		if injection.GetConfig(ctx) == nil {
			logging.FromContext(ctx).Panic(
				"Unable to fetch github.com/tektoncd/resolution/pkg/client/clientset/versioned.Interface from context. This context is not the application context (which is typically given to constructors via sharedmain).")
		} else {
			logging.FromContext(ctx).Panic(
				"Unable to fetch github.com/tektoncd/resolution/pkg/client/clientset/versioned.Interface from context.")
		}
	}
