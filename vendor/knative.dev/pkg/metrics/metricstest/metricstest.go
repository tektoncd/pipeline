...
func lastRow(t ti, name string, meter view.Meter) *view.Row {
	t.Helper()
	var d []*view.Row
	var err error
	if meter != nil {
...
func checkExactlyOneRow(t ti, name string) (*view.Row, error) {
...
func checkRowTags(t ti, row *view.Row, name string, wantTags map[string]string) {
	t.Helper()
