...
🗂  Taskruns
 ...
 NAME                                                    TASK NAME   STARTED          DURATION     STATUS
 ∙ pipelinerun-runon-failure-conflicted-task2-5bfz4   task2       ---              ---          Failed(SkippedRunOnStatusMismatch)
...
marked with a state `SkippedRunOnStatusMismatch`.
...
🗂  Taskruns
 ...
 NAME                                                 TASK NAME   STARTED          DURATION     STATUS
 ∙ pipelinerun-runon-success-failure-task2-wxn9n   task2       ---              ---          Failed(SkippedRunOnStatusMismatch)
...
execution and marks `TaskRun` for `task3` and `task5` as skipped with `SkippedRunOnStatusMismatch` state since `task1` succeeds.
...
🗂  Taskruns
 ...
 ∙ pipelinerun-two-branches-mix-of-success-failure-task3-8mhh9   task3       16 minutes ago   ---          Failed(SkippedRunOnStatusMismatch)
 ∙ pipelinerun-two-branches-mix-of-success-failure-task5-96zkh   task5       16 minutes ago   ---          Failed(SkippedRunOnStatusMismatch)
