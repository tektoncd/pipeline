...
func TestPipelineRun(t *testing.T) {
	...
	type tests struct {
		name                   string
		testSetup              func(ctx context.Context, t *testing.T, c *clients, namespace string, index int) (map[string]*v1alpha1.PipelineResource, *v1alpha1.Pipeline)
		expectedTaskRuns       []string
		expectedNumberOfEvents int
		pipelineRunFunc        func(*testing.T, int, string, string, map[string]*v1alpha1.PipelineResource) *v1alpha1.PipelineRun
	}
	...
	tds := []tests{{
		...
		testSetup: func(ctx context.Context, t *testing.T, c *clients, namespace string, index int) (map[string]*v1alpha1.PipelineResource, *v1alpha1.Pipeline) {
			...
			p := getFanInFanOutPipeline(t, tasks)
...
`, helpers.ObjectNameForTest(t)))
			...
			p := getHelloWorldPipelineWithSingularTask(t, task.Name)
			if _, err := c.PipelineClient.Create(ctx, p, metav1.CreateOptions{}); err != nil {
				t.Fatalf("Failed to create Pipeline `%s`: %s", p.Name, err)
			}
		...
		testSetup: func(ctx context.Context, t *testing.T, c *clients, namespace string, index int) (map[string]*v1alpha1.PipelineResource, *v1alpha1.Pipeline) {
			t.Helper()
			cond := getFailingCondition(t, namespace)
...
`, helpers.ObjectNameForTest(t)))
			...
			p := getPipelineWithFailingCondition(t, task.Name, cond.Name)
			if _, err := c.PipelineClient.Create(ctx, p, metav1.CreateOptions{}); err != nil {
				t.Fatalf("Failed to create Pipeline `%s`: %s", p.Name, err)
			}
	...
	for i, td := range tds {
		...
		t.Run(td.name, func(t *testing.T) {
			...
			pipelineRun, err := c.PipelineRunClient.Create(ctx, td.pipelineRunFunc(t, i, namespace, p.Name, resources), metav1.CreateOptions{})
			if err != nil {
...
func getHelloWorldPipelineWithSingularTask(t *testing.T, taskName string) *v1alpha1.Pipeline {
...
spec:
  ...
  - name: %s
    ...
    taskRef:
      name: %s
`, helpers.ObjectNameForTest(t), task1Name, taskName))
}

func getFanInFanOutTasks(t *testing.T) map[string]*v1alpha1.Task {
	return map[string]*v1alpha1.Task{
		"create-file": parse.MustParseAlphaTask(t, fmt.Sprintf(`
metadata:
  name: %s
spec:
  resources:
...
`, helpers.ObjectNameForTest(t))),
		"check-create-files-exists": parse.MustParseAlphaTask(t, fmt.Sprintf(`
metadata:
  name: %s
spec:
  resources:
...
`, helpers.ObjectNameForTest(t))),
		"check-create-files-exists-2": parse.MustParseAlphaTask(t, fmt.Sprintf(`
metadata:
  name: %s
spec:
  resources:
  ...
  - args: ['-c', 'echo else > $(outputs.resources.workspace.path)/else']
    ...
    name: write-data-task-1
`, helpers.ObjectNameForTest(t))),
		"read-files": parse.MustParseAlphaTask(t, fmt.Sprintf(`
metadata:
  name: %s
spec:
  resources:
...
func getFanInFanOutPipeline(t *testing.T, tasks map[string]*v1alpha1.Task) *v1alpha1.Pipeline {
	return parse.MustParseAlphaPipeline(t, fmt.Sprintf(`
metadata:
  name: %s
spec:
  ...
  - name: check-fan-in
    ...
    taskRef:
      name: %s
`, helpers.ObjectNameForTest(t), tasks["create-file"].Name, tasks["check-create-files-exists"].Name,
...
func getFanInFanOutPipelineRun(t *testing.T, _ int, namespace string, pipelineName string, resources map[string]*v1alpha1.PipelineResource) *v1alpha1.PipelineRun {
...
func getHelloWorldPipelineRun(t *testing.T, suffix int, namespace string, pipelineName string, _ map[string]*v1alpha1.PipelineResource) *v1alpha1.PipelineRun {
	return parse.MustParseAlphaPipelineRun(t, fmt.Sprintf(`
metadata:
  labels:
...
func getPipelineWithFailingCondition(t *testing.T, taskName, condName string) *v1alpha1.Pipeline {
	return parse.MustParseAlphaPipeline(t, fmt.Sprintf(`
metadata:
  name: %s
spec:
...
func getFailingCondition(t *testing.T, namespace string) *v1alpha1.Condition {
...
func getConditionalPipelineRun(t *testing.T, _ int, namespace string, pipelineName string, _ map[string]*v1alpha1.PipelineResource) *v1alpha1.PipelineRun {
	return parse.MustParseAlphaPipelineRun(t, fmt.Sprintf(`
metadata:
  name: %s
  namespace: %s
