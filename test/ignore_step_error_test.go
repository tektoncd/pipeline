...
spec:
  pipelineSpec:
	...
	if err := WaitForPipelineRunState(ctx, c, pipelineRun.Name, timeout, FailedWithReason(v1beta1.PipelineRunReasonFailed.String(), pipelineRun.Name), "Tasks Completed: 1 (Failed: 1, Cancelled 0), Skipped: 1"); err != nil {
